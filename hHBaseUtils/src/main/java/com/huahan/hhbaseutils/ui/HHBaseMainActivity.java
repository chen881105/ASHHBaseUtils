...
public abstract class HHBaseMainActivity extends HHBaseActivity
{
	...
	{
		View view=View.inflate(this, R.layout.hh_include_base_main_bottom, null);
		...
		mItemGroup.setOnCheckedChangeListener(new OnCheckedChangeListener()
		{
			...
			public void onCheckedChanged(RadioGroup group, int checkedId)
			{
				if (onItemChecked(checkedId-1))
				{
					...
					Fragment fragment = mFragManager.findFragmentByTag(checkedId+"");
					if (fragment==null)
					{
						fragment=getFragment(checkedId-1);
						transaction.add(R.id.hh_fl_base_main, fragment,checkedId+"");
					}
...
//	 * @param topMargin
//	 */
//	protected void addViewToMainBottom(View view,int itemPosi,int rightMargin,int topMargin)
//	{
