...
public class HHWebDataUtils
{
	 ...
	 */
	public static String sendSoapRequest(SoapObject rpc,String url,String nameSplace,String method) 
	{
		try {
	 ...
	 * @return
	 */
	public static String sendPostRequest(String requestUrl,Map<String, String> param,Map<String, String> headers)
	{
	 ...
	 * @return
	 */
	public static String sendPostRequest_Client(String requestUrl,Map<String, String> paramMap,Map<String, String> headerMap)
	{
	 ...
	 * @return
	 */
	public static String sendPostRequest_Client(String requestUrl,Map<String, String> paramMap,Map<String,String> fileMap,Map<String, String> headerMap)
	{
	 ...
	 * @return						请求失败的情况下返回null
	 */
	public static String sendPostRequest_B(String requestUrl,Map<String, String> param)
	{
	 ...
	 * @return							请求失败的返回null
	 */
	public static String sendPostRequestWithArray_B(String requestUrl,Map<String, String> paramMap,Map<String, List<? extends HHAbsNameValueModel>> arrayMap)
	{
	 ...
	 * @return							请求失败的返回null
	 */
	public static String sendPostRequestWithArray_B(String requestUrl,Map<String, String> paramMap,Map<String, List<? extends HHAbsNameValueModel>> arrayMap,Map<String, String> headers)
	{
		...
		return HHEncryptUtils.decodeAES_B(result);
	}
	/**
	 * 发送Post请求
	 ...
	 * @return
	 */
	public static String sendPostRequest_B_D(String requestUrl,Map<String, String> paramMap,Map<String, List<? extends HHAbsNameValueModel>> arrayMap,String fileName,String filePath)
	{
	 ...
	 * @return
	 */
	public static String sendPostRequest_B_D(String requestUrl,Map<String, String> paramMap,Map<String, List<? extends HHAbsNameValueModel>> arrayMap,List<String> files)
	{
		Map<String, String> fileMap=new HashMap<String, String>();
	 ...
	 * @return
	 */
	public static String sendPostRequest_B_D(String requestUrl,Map<String, String> paramMap,Map<String, List<? extends HHAbsNameValueModel>> arrayMap,Map<String, String> fileMap)
	{
	 ...
	 * @return
	 */
	public static String sendPostRequest_B_D(String requestUrl,Map<String, String> paramMap,Map<String, List<? extends HHAbsNameValueModel>> arrayMap,Map<String, String> fileMap,Map<String, String> headers)
	{
		String serverResponse = null;
		HttpClient httpClient = new DefaultHttpClient();
		HttpContext httpContext = new BasicHttpContext();
		...
		if (paramMap != null || arrayMap != null)
		{
			...
			if (paramMap != null && !paramMap.isEmpty())
			{
				...
				while (iterator.hasNext())
				{
					...
					builder.append("\"" + key + "\":\"" + HHEncryptUtils.encodeBase64(paramMap.get(key)) + "\",");
				}
				builder.deleteCharAt(builder.length() - 1);
			}
					...
					if (list != null && list.size() != 0)
					{
						...
						for (HHAbsNameValueModel absNameValueModel : list)
						{
							...
							if (nameValueList != null && nameValueList.size() != 0)
							{
								...
								{
									builder.append("\"" + basicNameValuePair.getName() + "\":\"" + HHEncryptUtils.encodeBase64(basicNameValuePair.getValue()) + "\",");
								}
								builder.deleteCharAt(builder.length() - 1);
								builder.append("}");
								builder.append(",");
			...
			String paramInfo=HHEncryptUtils.encodeAES_B(builder.toString());
			HHLog.i(tag, "getPostRequestParamString:"+param);
			String json=addPara?"para="+paramInfo:paramInfo;
			HHLog.i(tag, "getPostRequestParamString:"+json);
			return json;
		}
		return null;
	}
	...
	{
		return getPostRequestParamString(paramMap, arrayMap,true);
	}
	/**
	 * 发送post请求获取数据
	 * @param requestUrl 请求地址
	 ...
	 * @return
	 */
	public static String sendPostRequest_B_D(String requestUrl,Map<String, String> paramMap,Map<String,String> fileMap)
	{
